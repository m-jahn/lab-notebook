...
```{r, fig.height = 5, fig.width = 3.5}
print(plot_OD(df_OD_20220404, groups = "replicate"), split = c(1,1,1,2), more = TRUE)
print(plot_MU(df_mu_20220404, groups = "replicate"), split = c(1,2,1,2), more = TRUE)
```
...
bind_rows(.id = "experiment",
  ...
  df_mu_20211214,
  df_mu_20220114,
  df_mu_20220404 %>% filter(sample == "hoxG")) %>%
