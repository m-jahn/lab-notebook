...
bind_rows(.id = "experiment",
  ...
  plot_barchart("sample", "mu_max", ylim = c(0, 0.4), offset = 0.07, xrot = 35) %>%
  print(position = c(0,0,0.5,1), more = TRUE)
...
- no significant trend visible, and variation was quite high as already seen in
  chemostat OD measurements
...
![Gel with 16 PCR products and expected size 180 = bp](/home/michael/Documents/SciLifeLab/Experiments/20220420_NO3_TnLib_NGS_prep/gel_crop.png)
